...
class WebColors
{
    ...
    public static function human2hex($color_name)
    {
        $color_name = strtolower((string) $color_name);
        if (array_key_exists($color_name, self::$color_map)) {
            return self::$color_map[$color_name];
        }
        return FALSE;
    }

    public static function hex2human($color_code)
    {
